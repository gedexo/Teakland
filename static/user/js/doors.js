    ...
    $.ajax({
        ...
        statusCode: {
            ...
            201: function (response) {
                var jointType = $("select[name=jointType] option:selected").text();
                ...
                tableData.push([response['date'], rowMaterial,response['doortype'], jointType, response['labour_charge'],response['price'],edit, deleteProduct])
                table.rows.add(tableData).draw();
            },
            208: function (){
